          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-5xl w-full px-4 p-6 backdrop-blur-lg rounded-2xl text-center">
              <AnimatedGroup variants={transitionVariants}>
                <ShimmerBadge />
                <h1 className="mt-8 max-w-5xl mx-auto bg-gradient-text-radial bg-clip-text text-transparent text-balance text-3xl md:text-7xl lg:mt-16 xl:text-[5.25rem] font-semibold pb-2.5">
