...
export default function HeroSection() {
    return (
        <div className="flex overflow-hidden min-h-screen relative flex-col justify-center gap-5 items-center px-10">
            <Spotlight
            ...
            <motion.h1
                className="text-6xl text-center max-sm:text-4xl max-w-4xl font-semibold"
                initial={{ opacity: 0, y: 50, scale: 0.95 }}
                whileInView={{ opacity: 1, y: 0, scale: 1 }}
            ...
            <motion.p
                className="text-muted-foreground max-w-lg text-center"
                initial={{ opacity: 0, y: 50, scale: 0.95 }}
                whileInView={{ opacity: 1, y: 0, scale: 1 }}
